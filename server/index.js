...
// Middleware
app.use(cors({
  origin: ['https://trade-web-zeta.vercel.app', 'http://localhost:3000', 'http://localhost:5173', 'https://fin-trade.netlify.app'], // Add all possible frontend origins, no trailing slashes
